...
chdir(path.dirname(path.abspath(__file__))[:-10])
...
"border-radius: 20%;")
        ...
        self.icon_of_file.setLayoutMode(QtWidgets.QListView.LayoutMode.SinglePass)
        self.icon_of_file.setViewMode(QtWidgets.QListView.ViewMode.IconMode)
        ...
        item.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/Users/xmass/Downloads/1168220-200.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        item.setIcon(icon)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.name_of_file.setSpacing(9)
